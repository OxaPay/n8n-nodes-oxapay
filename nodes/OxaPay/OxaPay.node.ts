...
import { oxapayRequest, toOxaPayNodeApiError } from './helpers';

export class OxaPay implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			// ---------------------- Generate Invoice Link ----------------------
			{
				...
				default: undefined,
				description:
					'The amount for the payment. If Currency is empty, the amount is in USD. If Currency is set, the amount corresponds to the specified currency.',
			},
			{
				...
				options: [
					{
						...
						default: '',
						description:
							'1 indicates that the payer will pay the fee, while 0 indicates that the merchant will pay the fee. Default: Merchant setting.',
					},
					...
					},
					{
						...
						default: undefined,
						description:
							'Specify the acceptable inaccuracy in payment (0..60). Determines the maximum acceptable difference between requested and paid amount. Default: Merchant setting.',
					},
					{
					...
					},
					{
						...
						default: false,
						description:
							'If enabled, the received currency will be sent to the address specified in your Address List on the Settings page. If disabled, the amount will be credited to your OxaPay balance.',
					},
					{
						...
						default: false,
						description:
							"Specify whether the payer can cover the remaining amount with another currency if they pay less than the invoice amount. Default: Merchant setting.",
					},
					{
						displayName: 'Email',
						name: 'email',
				...
				options: [
					{
						...
						default: '',
						description:
							'Specify whether the payer will cover the invoice commission. Default: Merchant setting.',
					},
					{
						displayName: 'Under Paid Coverage',
						name: 'under_paid_coverage',
						...
						default: undefined,
						description:
							'Specify the acceptable inaccuracy in payment (0..60). Default: Merchant setting.',
					},
					{
						displayName: 'To Currency',
						name: 'to_currency',
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						default: false,
						description:
							'If enabled, the received amount will be automatically withdrawn to the address in your Address List. If disabled, it will be credited to your OxaPay balance.',
					},
					{
						displayName: 'Email',
						name: 'email',
			...
			// ---------------------- List Static Addresses (Filters) ----------------------
			{
				...
				options: [
					...
					},
					{
						...
						default: '',
						description:
							'Filter addresses by the expected blockchain network for the specified cryptocurrency.',
					},
					{
						displayName: 'Currency',
						name: 'currency',
					...
					},
					{
						...
						default: 50,
						description:
							'Number of records to display per page. Default is 50. Maximum is 200.',
					},
				],
			},
			...
			// ---------------------- Get Payment Information ----------------------
			{
				...
				default: '',
				description:
					'A unique identifier for the payment session used to track and retrieve payment details.',
			},
			...
			// ---------------------- List Payments (Filters) ----------------------
			{
				...
				options: [
					...
					},
					{
						...
						default: '',
						description:
							'Filter payments by a specific cryptocurrency symbol in which the pay amount is specified.',
					},
					{
						displayName: 'Currency',
						name: 'currency',
					...
					},
					{
						...
						default: '',
						description:
							'Filter payments by the expected blockchain network for the specified cryptocurrency.',
					},
					{
						displayName: 'Address',
						name: 'address',
					...
					},
					{
						...
						default: undefined,
						description:
							'The start of the date window to query for payments in UNIX timestamp format.',
					},
					{
						displayName: 'To Date',
						name: 'to_date',
						...
						default: undefined,
						description:
							'The end of the date window to query for payments in UNIX timestamp format.',
					},
					{
						...
						default: undefined,
						description:
							'Filter payments with amounts greater than or equal to this value.',
					},
					{
						...
						default: undefined,
						description:
							'Filter payments with amounts less than or equal to this value.',
					},
					{
						displayName: 'Sort By',
						name: 'sort_by',
			...
			// ---------------------- Get Payout Information ----------------------
			{
				...
				default: '',
				description:
					'Returns detailed information about a specific payout using its Track ID.',
			},
			...
			// ---------------------- List Payouts ----------------------
			{
				...
				options: [
					...
					},
					{
						...
						default: '',
						description:
							'Filter payouts by the expected blockchain network for the specified cryptocurrency.',
					},
					{
						displayName: 'Address',
						name: 'address',
						...
						default: '',
						description:
							'Filter payouts by the expected address.',
					},
					{
						displayName: 'From Date',
						name: 'from_date',
						...
						default: undefined,
						description:
							'The start of the date window to query for payouts in UNIX timestamp format.',
					},
					{
						displayName: 'To Date',
						name: 'to_date',
						...
						default: undefined,
						description:
							'The end of the date window to query for payouts in UNIX timestamp format.',
					},
					{
						displayName: 'From Amount',
						name: 'from_amount',
						...
						default: undefined,
						description:
							'Filter payouts with amounts greater than or equal to this value.',
					},
					{
						displayName: 'To Amount',
						name: 'to_amount',
						...
						default: undefined,
						description:
							'Filter payouts with amounts less than or equal to this value.',
					},
					{
						displayName: 'Sort By',
						name: 'sort_by',
				...
				options: [
					{
						...
						default: undefined,
						description:
							'Filter specific exchange by it`s trackId.',
					},
					{
						displayName: 'Type',
						name: 'type',
					...
					},
					{
						...
						default: undefined,
						description:
							'The start of the date window to query for swaps in UNIX timestamp format.',
					},
					{
						displayName: 'To Date',
						name: 'to_date',
						...
						default: undefined,
						description:
							'The end of the date window to query for swaps in UNIX timestamp format.',
					},
					{
						displayName: 'Sort By',
						name: 'sort_by',
			...
			// ---------------------- Account Balances ----------------------
			{
				...
				default: '',
				description:
					'Enter your OxaPay General API Key. You can obtain your General API Key on <a href="https://app.oxapay.com/settings" target="_blank">OxaPay Settings</a>.',			},
			{
				displayName: 'Currency',
				name: 'a_currency',
				type: 'string',
				...
				default: '',
				description:
					'Specify a specific currency to get the balance for that currency.',
			},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		for (let i = 0; i < items.length; i++) {
			...
			const bool01 = (v: any) => (v === undefined ? undefined : v ? '1' : '0');
			const cleanBody = (obj: Record<string, any>) =>
				Object.fromEntries(
					Object.entries(obj).filter(([, v]) => v !== undefined && v !== null && v !== ''),
				);

			const cleanQs = (obj: Record<string, any>) =>
				Object.fromEntries(
					Object.entries(obj).filter(([, v]) => v !== undefined && v !== null && v !== ''),
				);

			const parseJson = (raw: string, fieldName: string) => {
				try {
			...
			try {
				...
				// ---------------- PAYMENT ----------------
				if (resource === 'payment') {
					const normalizeInvoiceAdditional = (af: Record<string, any>) => ({
						...af,
					...
					const normalizeWhiteLabelAdditional = (af: Record<string, any>) => ({
						...af,
						auto_withdrawal: af.auto_withdrawal === undefined ? undefined : bool01(af.auto_withdrawal),
					});

					const normalizeStaticAdditional = (af: Record<string, any>) => ({
						...af,
						auto_withdrawal: af.auto_withdrawal === undefined ? undefined : bool01(af.auto_withdrawal),
					});
					...
					if (operation === 'generateInvoice') {
						const additionalFieldsRaw = this.getNodeParameter('additionalFields', i, {}) as Record<string, any>;
						...
						response = await oxapayRequest.call(this, 'merchant', 'POST', '/payment/invoice', { body });
					}

					// ---------------- Generate White Label ----------------
					if (operation === 'generateWhiteLabel') {
						const additionalFieldsRaw = this.getNodeParameter('wl_additionalFields', i, {}) as Record<string, any>;
						...
						response = await oxapayRequest.call(this, 'merchant', 'POST', '/payment/white-label', { body });
					}

					// ---------------- Generate Static Address ----------------
					if (operation === 'generateStaticAddress') {
						const additionalFieldsRaw = this.getNodeParameter('sa_additionalFields', i, {}) as Record<string, any>;
						...
						response = await oxapayRequest.call(this, 'merchant', 'POST', '/payment/static-address', { body });
					}
					// ---------------- Revoke Static Address ----------------
					if (operation === 'revokeStaticAddress') {
						...
						response = await oxapayRequest.call(this, 'merchant', 'POST', '/payment/static-address/revoke', { body });
					}

					// ---------------- List Static Addresses ----------------
					if (operation === 'listStaticAddresses') {
						const filters = this.getNodeParameter('sa_filters', i, {}) as Record<string, any>;
						const qs = cleanQs(filters);

						response = await oxapayRequest.call(this, 'merchant', 'GET', '/payment/static-address', { qs });
					}

					// ---------------- Get Payment Information ----------------
					if (operation === 'getPaymentInformation') {
						const trackId = this.getNodeParameter('payment_track_id', i) as string;

						response = await oxapayRequest.call(
							this,
							'merchant',
							'GET',
					...
					if (operation === 'listPayments') {
						const filters = this.getNodeParameter('payment_filters', i, {}) as Record<string, any>;
						const qs = cleanQs(filters);

						response = await oxapayRequest.call(this, 'merchant', 'GET', '/payment', { qs });
					}

					// ---------------- Accepted Currencies ----------------
					if (operation === 'acceptedCurrencies') {
						response = await oxapayRequest.call(this, 'merchant', 'GET', '/payment/accepted-currencies');
					}

					// ---------------- Payment Statistics ----------------
					if (operation === 'paymentstats') {
						const filters = this.getNodeParameter('ps_filters', i, {}) as Record<string, any>;
						const qs = cleanQs(filters);

						response = await oxapayRequest.call(this, 'merchant', 'GET', '/payment/stats', { qs });

					}

					// ---------------- Custom Payment Call ----------------
					if (operation === 'customPaymentCall') {
						const method = this.getNodeParameter('custom_method', i) as string;
						const endpoint = "/payment" + this.getNodeParameter('custom_endpoint', i) as string;

						let body: any = undefined;
						let qs: any = undefined;

						if (method === 'GET') {
							const qsRaw = this.getNodeParameter('custom_qs', i) as string;
							qs = cleanQs(parseJson(qsRaw, 'Query Parameters'));
						} else {
							const bodyRaw = this.getNodeParameter('custom_body', i) as string;
							body = parseJson(bodyRaw, 'Body (JSON)');
						}

						response = await oxapayRequest.call(this, 'merchant', method as any, endpoint, { qs, body });
					}
				}
				...
				if (resource === 'payout') {
					...
					if (operation === 'generatePayout') {
						...
						response = await oxapayRequest.call(this, 'payout', 'POST', '/payout', { body });
					}
					// ---------------- Get Payout Information ----------------
					if (operation === 'getPayoutInfo') {
						const trackId = this.getNodeParameter('payout_track_id', i) as string;

						response = await oxapayRequest.call(
							this,
							'payout',
							'GET',
							`/payout/${encodeURIComponent(trackId)}`,
						);
					}

					// ---------------- List Payout (Payment History) ----------------
					if (operation === 'listPayouts') {
						const filters = this.getNodeParameter('payout_filters', i, {}) as Record<string, any>;
						const qs = cleanQs(filters);

						response = await oxapayRequest.call(this, 'payout', 'GET', '/payout', { qs });
					}
					...
					if (operation === 'customPayoutCall') {
						const method = this.getNodeParameter('custom_method', i) as string;
						const endpoint = "/payout" + this.getNodeParameter('custom_endpoint', i) as string;
						...
						response = await oxapayRequest.call(this, 'payout', method as any, endpoint, { qs, body });
					}
				}
				...
				if (resource === 'swap') {
					...
					if (operation === 'generateSwap') {
						...
						response = await oxapayRequest.call(this, 'general', 'POST', '/general/swap', { body });
					}
					...
					if (operation === 'calculateSwap') {
						...
						response = await oxapayRequest.call(this, 'general', 'POST', '/general/swap/calculate', { body });
					}
					...
					if (operation === 'getSwapRate') {
						...
						response = await oxapayRequest.call(this, 'general', 'POST', '/general/swap/rate', { body });
					}


					// ---------------- Swap Pairs ----------------
					if (operation === 'swapPairs') {
						response = await oxapayRequest.call(this, 'general', 'GET', '/general/swap/pairs');
					}


					// ---------------- List Swap (Swap History) ----------------
					if (operation === 'searchSwaps') {
						const filters = this.getNodeParameter('swap_filters', i, {}) as Record<string, any>;
						const qs = cleanQs(filters);

						response = await oxapayRequest.call(this, 'general', 'GET', '/general/swap', { qs });
					}
					...
					if (operation === 'customSwapCall') {
						const method = this.getNodeParameter('custom_method', i) as string;
						const endpoint = "/general/swap" + this.getNodeParameter('custom_endpoint', i) as string;
						...
						response = await oxapayRequest.call(this, 'general', method as any, endpoint, { qs, body });
					}
				}
				...
				if (resource === 'common') {
					...
					if (operation === 'getAccountBalances') {
						const a_general_key = this.getNodeParameter('a_general_key', i) as string;
						const a_currency = this.getNodeParameter('a_currency', i) as string;
						const qs = cleanQs({general_api_key: a_general_key, currency: a_currency }); 

						response = await oxapayRequest.call(this, 'generalInline', 'GET', '/general/account/balance', { qs });
					}
					...
					if (operation === 'getPrices') {
						...
						response = await oxapayRequest.call(this, 'common', 'GET', '/common/prices');
					}
					...
					if (operation === 'getSupportedCurrencies') {
						...
						response = await oxapayRequest.call(this, 'common', 'GET', '/common/currencies');
					...
					if (operation === 'getSupportedFiatCurrencies') {
						...
						response = await oxapayRequest.call(this, 'common', 'GET', '/common/fiats');
					...
					if (operation === 'getSupportedNetworks') {
						...
						response = await oxapayRequest.call(this, 'common', 'GET', '/common/networks');
					...
					if (operation === 'getSystemStatus') {
						...
						response = await oxapayRequest.call(this, 'common', 'GET', '/common/monitor');
					...
					if (operation === 'customCommonCall') {
						const method = this.getNodeParameter('custom_method', i) as string;
						const endpoint = "/common" + this.getNodeParameter('custom_endpoint', i) as string;
						...
						response = await oxapayRequest.call(this, 'common', method as any, endpoint, { qs, body });
					}

				}

				if (response === undefined) {
					throw new NodeOperationError(this.getNode(), `Unhandled operation: ${resource}.${operation}`);
				}

				returnData.push({ json: response });
			} catch (err: any) {
				const error =
					err?.response || err?.statusCode || err?.options?.url
						? toOxaPayNodeApiError.call(this, err, i)
						: new NodeOperationError(this.getNode(), err?.message ?? 'OxaPay request failed', {
								itemIndex: i,
							});
